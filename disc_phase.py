...
if __name__ == "__main__":
    ...
    MW = pyn.load('/home/kellerbw/ssd/reproducible/mw/sb1/disc.01000')
    MW.g['rho'].convert_units('m_p cm**-3')
    MWE = MW.g['uHot']*MW.g['MassHot']+MW.g['u']*(MW.g['mass']-MW.g['MassHot'])
    MWrho = np.concatenate((MW.g['rho']*MWE/(MW.g['mass']*MW.g['u']), MW.g['rho']*MWE/(MW.g['mass']*MW.g['uHot'])))
    MWtemp = np.concatenate((MW.g['temp'], MW.g['temp']/MW.g['u']*MW.g['uHot']))
    plt.hexbin(MWrho, MWtemp, xscale='log', yscale='log', bins='log', extent=(-5,4,2,9),
            mincnt=1, gridsize=200, cmap='binary')
